...
struct proc {
  ...
  //task2
  int mask; // checking if bit p turned mask & (1<<p)
  //task2
  ...
  int average_bursttime; // bursttime- approximate estimated burst time (as specified in task 4.3)
  //struct perf *performance; 
  //task3

  //task4
  int ticks; // how many ticks 
  uint64 arrayPlace; // for the queue in fcfs
  int myPriority;
  int startBurstTime; // the start of counting burstTime
  //task4
